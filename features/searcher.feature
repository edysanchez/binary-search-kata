Feature: Search a number in an ordered list of Numbers
    ...
    Scenario: Search a number not in a list with 3 elements
        Given I have the list "1,2,3"
        When I search the number "1"
        Then I should find it
    ...
    Scenario: Search a number in a list with 5 elements
        Given I have the list "1,2,3,4,5"
        When I search the number "2"
        Then I should find it

    Scenario: Search a number in a list with 5 elements
        Given I have the list "1,2,3,4,5"
        When I search the number "4"
        Then I should find it
